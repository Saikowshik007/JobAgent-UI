...
function Footer() {
  ...
  return (
    <footer
      ...
      } transform transition-all duration-700 ease-out bg-gradient-to-r from-[#0f2027] via-[#203a43] to-[#2c5364] text-gray-300 text-xs py-3 px-4 text-center shadow-inner`}
    >
