// src/components/JobList.js - Updated for improved UI
import React, { useState } from "react";

function JobList({ jobs, userId, selectedJob, onJobClick }) {
              ...
              return (
                <li
                  ...
                  className={`px-4 py-4 hover:bg-gray-50 cursor-pointer transition duration-150 ease-in-out ${
                    isSelected ? "bg-indigo-50 border-l-4 border-indigo-500 pl-3" : ""
                  }`}
